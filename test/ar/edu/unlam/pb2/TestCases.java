...
//		assertEquals(0.0, ag600.getAltura());
...
//		argentina.agregarVehiculo(new Anfibio(12, "A-10"));
		//argentina.crearBatalla("San Lorenzo", TipoDeBatalla.TERRESTRE, 100.5, 20.3);
		argentina.agregarVehiculo(new Tanque(5, "Renault FT"));
		argentina.agregarVehiculo(new Camion(6, "T-71"));
		argentina.agregarVehiculo(new Camion(7, "T-72"));

		
		Batalla nueva = argentina.crearBatalla("San Lorenzo", TipoDeBatalla.TERRESTRE, 100.5, 20.3);
	...
	public void queSePuedaPresentarBatallaNaval() throws VehiculoInexistente, VehiculoIncompatible {
		...
		assertEquals(4, argentina.getCapacidadDeDefensa(), 0.01);
